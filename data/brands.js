const brands = {
  ...
  dispotech: {
    ...
    watermarkLogo: "/images/manufacturers/dispotech-logo.svg",
    website: "https://www.dispotech.com/es",
    logoClassName: "h-16",
    watermarkLogoClassName: "h-44",
  ...
  bartoliniDentalGroup: {
    ...
    watermarkLogo: "/images/manufacturers/bartolini-logo.svg",
  ...
  irideInternational: {
    ...
    watermarkLogoOpacityClassName: "opacity-[0.48]",
  ...
  willPharma: {
    ...
    watermarkLogo: "/images/manufacturers/willpharma-logo.svg",
  ...
  microMedica: {
    ...
    watermarkLogo: "/images/manufacturers/micromedica-logo.svg",
